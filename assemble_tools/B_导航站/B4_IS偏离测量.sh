...
CMD="roslaunch guiding_beacon guiding_station.launch"
RECORD="rosrun guiding_beacon marking_offset_tuning.py"
NEWCMD="rostopic pub -1 /gui/gs_0/cmdword std_msgs/String calinew"
RUNCMD="rostopic pub -1 /gui/gs_0/cmdword std_msgs/String calitrack"
CALICMD="rostopic pub -1 /gui/gs_0/cmdword std_msgs/String calimanual"

WNAME="marking_offset_tuning"
PWNAME="marking_offset_tuning_pub"
