...
echo "| line laser is overlap with the center line of long camera's image, then tune the short|"
echo "| camera so that the center line of short camera's image is overlap with line laser     |"
echo "-----------------------------------------------------------------------------------------"
