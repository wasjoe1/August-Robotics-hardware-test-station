...
SHOWCMD="python /home/$CURRENTUSER/catkin_ws/src/boothbot/boothbot_perception/test/track_on_device_sharpness.py /dev/camera_long 40 -c green --state_dict /home/$CURRENTUSER/catkin_ws/src/boothbot/boothbot_perception/scripts/boothbot_perception/models/linear_gray.p"
